...
NMEAGGA::NMEAGGA() : raw_sentence(""), raw_vtg_sentence(""), timestamp(""), latitude(0.0), lat_dir(' '), longitude(0.0), lon_dir(' '),
gps_qual(0), num_sats(0), hdop(0.0), altitude(0.0), speed_knots(0.0), valid(false) {
}
